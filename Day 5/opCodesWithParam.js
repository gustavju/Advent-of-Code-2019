...
const run = () => {
  ...
  while (index < data.length) {
    ...
    if (op1 == 1) {
      let p1 = pm1 == 0 ? data[data[index + 1]] : data[index + 1];
      let p2 = pm2 == 0 ? data[data[index + 2]] : data[index + 2];
      //let p3  = pm3 == 0 ? data[data[index + 3]] : data[index + 3]; // Denna borde aldrig vara i 1
